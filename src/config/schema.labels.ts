...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "marketplaces.feeds.*.verification.keys[].keyId": "Marketplace Feed Publisher Key ID",
  "marketplaces.feeds.*.verification.keys[].publicKey": "Marketplace Feed Publisher Public Key",
  "marketplaces.feeds.*.verification.threshold": "Marketplace Feed Verification Threshold",
  ...
  "cloudWorkers.profiles.*.lifetime.maxLifetimeMinutes": "Cloud Worker Maximum Lifetime (minutes)",
  gateway: "Gateway",
